...
mainBinaries = [
    ...
    ( 'sensor/bin/centos/*/x86_64/debug/rpHostCommonPlatformExe', 'hcp_centos_x64_debug_%s' ),
    ( 'sensor/bin/centos/*/x86_64/release/rpHostCommonPlatformExe', 'hcp_centos_x64_release_%s' ),
    ...
    ( 'sensor/bin/centos/*/x86_64/debug/librpHCP_HostBasedSensor.so', 'hbs_centos_x64_debug_%s.so' ),
    ( 'sensor/bin/centos/*/x86_64/release/librpHCP_HostBasedSensor.so', 'hbs_centos_x64_release_%s.so' ),
